...
void Display::begin()
{
  ...
  */
  ...
  Write_Command_Data(0x10, 0x0900);
  Write_Command_Data(0x11, 0x1038);
  Write_Command_Data(0x12, 0x1121);
  Write_Command_Data(0x13, 0x0065);
  Write_Command_Data(0x14, 0x5058);
  ...
  Write_Command_Data(0x50, 0x0400);
  Write_Command_Data(0x51, 0x060b);
  Write_Command_Data(0x52, 0x0c0a);
  Write_Command_Data(0x53, 0x0105);
  Write_Command_Data(0x54, 0x0a0c);
  Write_Command_Data(0x55, 0x0b06);
  Write_Command_Data(0x56, 0x0004);
  Write_Command_Data(0x57, 0x0501);
  Write_Command_Data(0x58, 0x0e00);
  Write_Command_Data(0x59, 0x000e);
